        ...
        if (response.success == "1") {
            ...
            for (var i = 0; i < response['products'].length; i++) {
                ...
                if (cont == 0) {
                    ...
                    $('#row-prod' + aux).append('<div class="col-lg-4 col-md-6" ' + type + '><div class="card">' +
                        ...
                        '<a href="#" data-original-title="Adicionar ao carrinho" type="button" data-toggle="tooltip" ' +
                        'data-placement="top" title=""> <i class="fa fa-cart-plus"></i> </a>' +
